                    ...
                    <form class="edit-form" action="includes/recipe-update.inc.php" method="post" style="display: none;">
                      ...
                      <div class="mb-3">
                        ...
                        <select class="form-select" id="roast_type_<?= $recipe['recipe_id']; ?>" name="roast_type">
                          <option value="light" <?= ($recipe['roast_type'] == 'light') ? 'selected' : ''; ?>>Jemne pražená</option>
                          <option value="medium" <?= ($recipe['roast_type'] == 'medium') ? 'selected' : ''; ?>>Stredne pražená</option>
                          <option value="dark" <?= ($recipe['roast_type'] == 'dark') ? 'selected' : ''; ?>>Tmavo pražená</option>
                        </select>
                      </div>
                      <div class="mb-3">
        ...
        <div class="custom-form p-5" style="background-color: <?= $background; ?>; color: <?= $color; ?>">
          ...
          <form id="recipeForm" action="includes/recipe.inc.php" method="post" class="row g-3" novalidate>
            ...
            <div class="col-md-12">
              ...
              <input type="number" class="form-control" style="background-color: <?= $background; ?>; color: <?= $color; ?>" id="water_amount" name="water_amount" required>
            ...
            <div class="col-md-12">
              ...
              <input type="number" class="form-control" style="background-color: <?= $background; ?>; color: <?= $color; ?>" id="coffee_amount" name="coffee_amount" required>
              <div class="invalid-feedback">
            ...
            <div class="col-md-12">
              ...
              <input type="text" class="form-control" style="background-color: <?= $background; ?>; color: <?= $color; ?>" id="recipe_name" name="recipe_name" required>
              <div class="invalid-feedback">
