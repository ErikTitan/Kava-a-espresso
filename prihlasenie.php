      ...
      <div class="row justify-content-center">
            ...
            <div class="custom-form p-5" style="background-color: <?php echo $background;?>; color: <?php echo $color;?>">
                ...
                <form id="myForm" action="includes/signup.inc.php" method="post" class="row g-3 needs-validation" novalidate>
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" style="background-color: <?php echo $background;?>; color: <?php echo $color;?>" id="username" name="uid" required>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="password" class="form-control" style="background-color: <?php echo $background;?>; color: <?php echo $color;?>" id="password" name="pwd" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="password" class="form-control" style="background-color: <?php echo $background;?>; color: <?php echo $color;?>" id="confirm_password" name="pwdrepeat" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-12 text-center">
                      <?php if (isset($_GET['reg_error'])) {echo '<div class="alert alert-danger" role="alert">' . $_GET['reg_error'] . '</div>';} ?>
                    </div>
                    <div class="col-12 text-center">
        ...
        <div class="col-lg-4">
          <div class="custom-form p-5" style="background-color: <?php echo $background; ?>; color: <?php echo $color; ?>">
            ...
            <form id="loginForm" action="includes/login.inc.php" method="post" class="row g-3 needs-validation" novalidate>
              <div class="col-md-12">
              ...
              <div class="col-12 text-center ">
                      <?php if (isset($_GET['log_error'])) {echo '<div class="alert alert-danger" role="alert">' . $_GET['log_error'] . '</div>';} ?>
                    </div> 
              <div class="col-12 text-center">
